...
# Coefficients
W_0 = 0.37558025165646036
W_C = -0.0022950704034157584
W_N = -0.15400622518706056
W_B = 0.3204805592334599
e = np.array([-0.09878011, 0.41885008, -0.21805042, 0.13258889, -0.47985709, -0.01039155, 0.27669627, -0.0962896, 0.07523353])

# Calculate R
R = W_0 + W_C * C_normalized + W_N * N_normalized + W_B * B_normalized + e

print("Calculated R values:")
print('pred_R:', R)
print('gt_R', R_avg)
