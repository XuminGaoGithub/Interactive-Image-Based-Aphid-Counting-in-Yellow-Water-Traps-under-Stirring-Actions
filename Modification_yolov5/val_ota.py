...
from utils.general import (LOGGER, check_dataset, check_img_size, check_requirements, check_yaml,
                           coco80_to_coco91_class, colorstr, emojis, increment_path, non_max_suppression, soft_nms, print_args,
...
def run(
    ...
    if not training:
        ...
        #our aphids dataset are already square, so we donot need this
        rect = False
        #print('rect: \n',rect)
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        #print('type(train_out)',type(train_out))
        ...
        if compute_loss:
            ...
            loss += compute_loss([x.float() for x in train_out], targets, im)[1]  # OTA
