...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir='', names=()):
        try:
            ...
            fig.axes[0].set_ylabel('Predicted',fontsize=16)
    ...
    def plot_with_name(self, normalize=True, save_dir='', names=(), image_name=''):
        try:
            import seaborn as sn
            ...
            fig.savefig(Path(save_dir) / (image_name + '_confusion_matrix.png'), dpi=250)
            plt.close()
        except Exception as e:
            print(f'WARNING: ConfusionMatrix plot failure: {e}')
...
def train_bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
...
#for soft_nms
def val_bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False, eps=1e-7):
...
### EIOU,SIOU,AlphaIOU
# refer to: https://www.bilibili.com/video/BV1tG4y1N7Gk/?spm_id_from=333.999.0.0&vd_source=400fac036b19d9beb706a8e110d9ebf0
'''
def train_bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, Focal=False,
...
def val_bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, Focal=False,
             alpha=1, gamma=0.5, scale=False, eps=1e-7):
    # Returns Intersection over Union (IoU) of box1(1,4) to box2(n,4)
