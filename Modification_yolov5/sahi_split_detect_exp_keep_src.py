    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        if mulpicplus == "1":
            ...
            for i in range(len(slice_bboxes)):
                ...
                cv2.imwrite('/home/xumin/yolov5/runs/slicing/' + str(num) + '_' + str(i) + '.jpg', cropped_image)
                ...
                for j, det in enumerate(pred_slice):
                    ...
                    #cv2.imwrite('/home/xumin/yolov5/runs/slicing/' + str(num) +'_'+str(i) + '_pred' + '.png', cropped_image)
