...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        for si, pred in enumerate(out):
            ...
            if len(pred)<165: # accpet the detection result of yolov5
            #if False: # for 412_2000_epochs_augument-trainingset/0model_best.pth.tar
            ...
            #print('paths[si]:',paths[si])
                ...
                #checkpoint = torch.load('/home/xumin/phd/CSRNet-pytorch-master/result/aphids_images_412_2000_epochs_augument-trainingset/0model_best.pth.tar')
