        ...
        for i, det in enumerate(pred):  # per image
            ...
            if save_img:
                if dataset.mode == 'image':
                    ...
                    im0 = cv2.resize(im0, (2000, 2000)) # this is the difference from sahi_split_detect_exp.py
                    count_number = "Aphids:{}".format(len(det))
                    cv2.putText(im0, count_number, (150, 150), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 0), 7)
